...
class NMT(nn.Module):
    ...
    def __init__(self, embed_size, hidden_size, vocab, dropout_rate=0.2):
        ...
        self.target_vocab_projection = nn.Linear(in_features=self.hidden_size, out_features=len(self.vocab.src), bias=False)
    ...
    def step(self, Ybar_t: torch.Tensor,
        ...
        #3
        e_t = torch.bmm(enc_hiddens_proj,  dec_hidden.unsqueeze(2)).squeeze(2) # (b, src_len, h) * (b, h)
